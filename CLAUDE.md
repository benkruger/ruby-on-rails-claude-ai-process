...
- `src/commands/utility_marker.rs` — per-session `<home>/.claude/flow/utility-in-progress-<session_id>.json` marker that the Stop hook reads to refuse turn-end while a multi-step utility skill is running (issue #1412)
