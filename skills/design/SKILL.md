...
```text
============================================
  FLOW v0.12.0 — Phase 3: Design — STARTING
============================================
```
````
...
Using the state data from the gate, cd into the worktree and update Phase 3:
- `status` → `in_progress`
...
```text
============================================
  FLOW v0.12.0 — Phase 3: Design — COMPLETE (<formatted_time>)
============================================
```
````
