...
```text
============================================
  FLOW v0.28.19 — Phase 5: Learn — STARTING
============================================
```
````
...
```bash
exec ${CLAUDE_PLUGIN_ROOT}/bin/flow set-timestamp --set learn_step=5
```
...
```text
============================================
  FLOW v0.28.19 — Phase 5: Learn — COMPLETE (<formatted_time>)
